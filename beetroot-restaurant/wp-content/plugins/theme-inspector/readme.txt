=== Theme Inspector ===
Contributors: Melissa Cabral
Donate link: http://wordpress.melissacabral.com/donate
...
1. There's nothing to configure. Theme Inspector will automatically appear when you view your website as an Administrator. Look at the upper-right corner of the Toolbar ("Admin Bar").
1. Hover over "Theme Inspector" for a flyout-panel containing information about the page you are currently viewing.
...
= 2.0 =
Upgrade because this version is way better than the last one and addresses a handful of minor bugs. 
